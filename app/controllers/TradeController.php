...
class TradeController extends \lithium\action\Controller {
	...
	static function get_markets() {

	global $markets;

	return $markets; //array('btc_tcp', 'btc_dct', 'tcp_dct');
	}
	...
	if(! in_array($currency, $this->get_markets()) ) {$this->redirect(array('controller'=>'ex','action'=>'dashboard/'));}
