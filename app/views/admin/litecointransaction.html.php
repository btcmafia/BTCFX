...
?>
<div class="col-md-4">
<form action="/Admin/litecointransaction" method="post">
...
<table class="table table-condensed table-bordered table-hover" style=" ">
	...
	<tr>
		...
		<td><a href="http://ltc.block-explorer.com/address/<?=$tx['address']?>" target="_blank"><?=$tx['address']?></a></td>
	</tr>
	<?php }?>
</table>
<br>
