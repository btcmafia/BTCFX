...
<p>We have received a request to update your email address to <?=$email?> at <?=COMPANY_NAME?></p>
<p>Please click the link below to confirm you own the email address:</p>
