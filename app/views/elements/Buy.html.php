...
<table class="table table-condensed " >
	...
	<tr>
		<td>
		<?=$this->form->field('BuyAmount', array('label'=>'Amount '.$first_curr,'class'=>'col-md-1 form-control numbers', 'value'=>0, 'onBlur'=>'$("#BuySubmitButton").attr("disabled", "disabled");','min'=>'0','max'=>'99999999','maxlength'=>'10')); ?>				
		</td>
		<td>
			<label for="BuyPriceper">Price per <?=$first_curr?></label>
		<div class="input-group">
			<input class="form-control col-md-1 numbers" id="BuyPriceper" name="BuyPriceper" type="text" onBlur='$("#BuySubmitButton").attr("disabled", "disabled");' min="0" max="99999999" maxlength="10">
