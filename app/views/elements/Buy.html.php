...
<table class="table table-condensed " >
	...
	<tr>
		<td>
		<?=$this->form->field('BuyAmount', array('label'=>'Amount '.$first_curr,'class'=>'col-md-1 form-control numbers', 'value'=>0, 'onBlur'=>'$("#BuySubmitButton").attr("disabled", "disabled");','min'=>'0.0001','max'=>'9999','maxlength'=>'10','type'=>'number','step'=>"0.00001")); ?>				
		</td>
		<td>
			<label for="BuyPriceper">Price per <?=$first_curr?></label>
		<div class="input-group">
			<input class="form-control col-md-1 numbers" id="BuyPriceper" name="BuyPriceper" type="number" onBlur='$("#BuySubmitButton").attr("disabled", "disabled");' min="0.0001" max="9999" maxlength="10" step="0.0001">
