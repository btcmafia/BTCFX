...
class Backup extends \lithium\console\Command {
	public function run(){
			...
			"/backup/VCCoUK/logins.bson",
			"/backup/VCCoUK/logins.metadata.json",
			...
			"/backup/VCCoUK/requests.bson",
			"/backup/VCCoUK/requests.metadata.json",
			...
			"/backup/VCCoUK/settings.bson",
			"/backup/VCCoUK/settings.metadata.json",
