...
/*
	Few edits from original, mainly changed Google Charts URL to https version
*/
...
class QRCode extends \lithium\action\Controller {
    ...
    //getting image  
    public function get_image($size = 250, $EC_level = 'L', $margin = '0'){
        $ch = curl_init();
    ...
    public function get_link($size = 250, $EC_level = 'L', $margin = '0'){
        ...
        return ' https://chart.googleapis.com/chart?chs='.$size.'x'.$size.'&cht=qr&chld='.$EC_level.'|'.$margin.'&chl='.$this->data;
    }
